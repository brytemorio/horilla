...
def start_automation():
    ...
    Automation signals
    """
    from ems_automations.methods.methods import get_model_class, split_query_string
...
def send_automated_mail(
    ...
    from ems_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from ems_automations.methods.methods import (
        get_model_class,
