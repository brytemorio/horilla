"""
ems_api/urls/attendance/urls.py
"""

from django.urls import path

from ems_api.api_views.attendance.permission_views import AttendancePermissionCheck
from ems_api.api_views.attendance.views import *
