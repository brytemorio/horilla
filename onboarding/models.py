...
class OnboardingStage(EmsModel):
    """
    ...
    objects = EmsCompanyManager("recruitment_id__company_id")
...
class OnboardingTask(EmsModel):
    ...
    objects = EmsCompanyManager("stage_id__recruitment_id__company_id")

    def __str__(self):
        return f"{self.task_title}"


class CandidateStage(EmsModel):
    """
    ...
    objects = EmsCompanyManager("candidate_id__recruitment_id__company_id")
...
class OnboardingPortal(EmsModel):
    """
